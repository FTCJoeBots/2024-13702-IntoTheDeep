...
{
  public static Vector2d SPECIMEN_BAR_LEFT = new Vector2d( 23, 7 );//good
  public static Vector2d SPECIMEN_BAR_RIGHT = new Vector2d( 23, -7 );//good

  //left edge of robot is 2 tiles over from left corner
  public static Vector2d STARTING_POSITION_BASKETS = new Vector2d( 0, 15.1 ); //good

  //right edge of robot is 2 tiles over from right corner
  public static Vector2d STARTING_POSITION_SPECIMENS = new Vector2d( 0, -15.6 ); //good
  public static Vector2d SAMPLE_BASKETS = new Vector2d( 8.8, 53 ); //good

  public static Vector2d NEAR_THE_OBSERVATION_ZONE = new Vector2d( 20.5, -61.9 ); //good
  public static Vector2d OBSERVATION_ZONE = new Vector2d( 7, -53.8 ); //good
  public static Vector2d PARK_IN_OBSERVATION_ZONE = new Vector2d( 4.5, -53.8 ); //good

  public static Vector2d NEAR_ASCENT_ZONE = new Vector2d( 63.9, 52 ); //good
  public static Vector2d ASCENT_ZONE = new Vector2d( 62.2, 25 ); //60.3, 19.7 ); //too far right!

  public static Vector2d NEAR_YELLOW_SAMPLES_1 = new Vector2d( 30, 40 );//good?
  public static Vector2d NEAR_YELLOW_SAMPLES_2 = new Vector2d( 60, 40 );// better?
  public static Vector2d YELLOW_SAMPLE_1 = new Vector2d( 22.3, 48 ); //good
  public static Vector2d YELLOW_SAMPLE_2 = new Vector2d( 52.9, 59.2 ); //good
  public static Vector2d YELLOW_SAMPLE_3 = new Vector2d( 50, 57.6 );//51.9, 51.1 );
